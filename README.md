...
Tapping a player opens a detail view with: their combined rank average and draft position; last-year and this-year-projection avg/game and total fantasy points (each with that source's rank, i.e. their "league rank" for that stat), pulled from whichever sources you've marked with those score types; their rank/score in every other source; and, at the bottom, "Mark Drafted"/"Undraft" plus "Drafted by me"/"Remove from My Team" — the latter both marks them drafted and adds them to the My Team tab in one step.
